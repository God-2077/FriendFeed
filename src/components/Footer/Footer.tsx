...
const Footer: FC<FooterProps> = () => {
  return (
    <footer className="page-footer">
      <p>
        Powered by <a href='https://github.com/God-2077/FriendFeed' target="_blank" rel="noopener noreferrer">FriendFeed</a> · Inspired by <a href="https://github.com/cosZone/astro-koharu" target="_blank" rel="noopener noreferrer">astro-koharu</a> ·  Designed with <RiHeart3Fill size={16} color="currentColor" className="heart-beat" /> by <a href="https://github.com/kissablecho" target="_blank" rel="noopener noreferrer">kissablecho</a>
      </p>
